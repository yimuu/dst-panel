      ...
      children: [
        {
          ...
          children: [
            ...
            { path: routes.adminlist, element: <PlayerListPage kind="adminlist" /> },
            { path: routes.whitelist, element: <PlayerListPage kind="whitelist" /> },
            { path: routes.blacklist, element: <PlayerListPage kind="blacklist" /> },
